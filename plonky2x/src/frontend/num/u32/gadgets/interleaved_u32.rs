// This file is copied from Jump Crypto's plonky2-crypto repo:
// https://github.com/JumpCrypto/plonky2-crypto/blob/main/src/u32/gadgets/interleaved_u32.rs
...
use crate::frontend::num::u32::gates::interleave_u32::U32InterleaveGate;
use crate::frontend::num::u32::gates::uninterleave_to_b32::UninterleaveToB32Gate;
use crate::frontend::num::u32::gates::uninterleave_to_u32::UninterleaveToU32Gate;
...
mod tests {
    ...
    use super::*;
    use crate::frontend::num::u32::witness::WitnessU32;
