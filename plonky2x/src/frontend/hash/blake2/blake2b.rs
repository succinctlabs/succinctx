...
mod tests {
    ...
    fn run_test<const MAX_MESSAGE_LENGTH: usize, const DIGEST_SIZE: usize>(
        ...
        info!("setting length to {:?}", msg.len());
        pw.set_target(
